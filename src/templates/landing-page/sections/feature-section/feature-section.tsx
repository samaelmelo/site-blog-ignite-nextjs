  ...
  return (
    <section className="container bg-gray-700 grid gap-6 md:grid-cols-2 pb-8 pt-8 md:py-10">
      ...
      <div className='col-span-full flex flex-col gap-2'>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounde-lg bg-gray-500 p-6 md:p-12">
          <div className="flex flex-col gap-4">
            ...
            >
              <Link href="/criar-loga">Criar loja grátis</Link>
            </Button>
          </div>

          <div className="flex flex-col items-center justify-center w-full">
            <div className="w-full ,ax-w-md overflow-hidden">
              <Image
