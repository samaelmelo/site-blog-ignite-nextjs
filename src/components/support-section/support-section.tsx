...
export const SupportSection = () => {
  return (
    <section className=" pb-8 md:py-10 bg-gradient-to-r bg-gray-700">
      <div className=" container flex flex-col items-center gap-12">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-cyan-300">
            <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-cyan-2 00 mb-4">
            ...
            <p className="text-body-sm text-gray-200">
              Não importa a loja, o Site.Set permite que vocˆ´insira a qualquer
              link de afiliado.
            </p>
          </div>
